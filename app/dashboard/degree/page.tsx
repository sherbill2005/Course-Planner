...
export default function DegreeProgress() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-[30px] border border-zinc-100 bg-white p-8 text-zinc-900 shadow-sm dark:border-0 dark:bg-[#212121] dark:text-white dark:shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)]">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {DEGREE_REQUIREMENTS.map((req) => {
          ...
          return (
            <div key={req.category} className="rounded-[30px] border border-zinc-100 bg-white p-6 text-zinc-900 shadow-sm dark:border-0 dark:bg-[#212121] dark:text-white dark:shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)]">
              <div className="mb-4 flex items-center justify-between">
                <h4 className="font-bold text-zinc-900 dark:text-white">{req.category}</h4>
                <span className="text-sm font-bold text-blue-600">{percentage}%</span>
              </div>
              
              <div className="mb-6 h-2 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-white/10">
                <div 
