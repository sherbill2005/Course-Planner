  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {plans.map((sem) => (
          <div key={sem.semester} className="rounded-[30px] border border-zinc-100 bg-white p-6 text-zinc-900 shadow-sm dark:border-0 dark:bg-[#212121] dark:text-white dark:shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)]">
            ...
            <div className="space-y-3">
              {sem.courses.map((course) => (
                <div key={course.id} className="flex items-center justify-between rounded-xl bg-zinc-50 p-4 dark:bg-[#2a2a2a]">
                  <div>
              ...
              <button className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-zinc-100 py-3 text-xs font-bold text-zinc-400 hover:border-blue-200 hover:text-blue-500 transition-all dark:border-zinc-700 dark:hover:border-blue-300 dark:hover:text-blue-400">
